...
import {measure, warnOnce} from '../../utils';
...
export class Tooltip extends React.Component<TooltipProps, TooltipState> {
    ...
    private fixedParent: HTMLElement | null = null;
