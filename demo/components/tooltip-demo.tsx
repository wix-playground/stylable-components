...
const samples = [
    ...
    {
        title: 'Click to open, click to close',
        props: {
            openTrigger: 'click',
            closeTrigger: 'click',
            children: longText
